...
import (
	...
	"github.com/suntoryota/go-eCommerce/models"
	"go.mongodb.org/mongo-driver/bson"
	"go.mongodb.org/mongo-driver/bson/primitive"
	"go.mongodb.org/mongo-driver/mongo"
)

var ErrCantFindProduct = errors.New("cant find the product")
var ErrCantDecodeProducts = errors.New("cant find the product")
var ErrUserIdNotValid = errors.New("this user is not valid")
var ErrCantUpdateUser = errors.New("cannot add this product")
var ErrCantRemoveItemCart = errors.New("cant remove this item from the cart")
var ErrCantGetItem = errors.New("was unable to get the item from the cart")
var ErrCantBuyCartItem = errors.New("cant update the purchase")
